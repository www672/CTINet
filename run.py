...
parser.add_argument('--model', type=str, default='CTINet',
...
parser.add_argument('--node', type=int, default=7, help='cycle length')
...
# print("use_llm:", getattr(args, "use_llm", False))
